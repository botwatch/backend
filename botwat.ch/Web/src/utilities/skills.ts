...
export const experienceTable = [0, 0, 83, 174, 276, 388, 512, 650, 801, 969, 1154, 1358, 1584, 1833, 2107,
...
export const skills = {getLevelAt, Skills};

export function getLevelAt(exp: number) {
    for (let i: number = 0; i < experienceTable.length; i++) {
